...
public abstract class LoginTopologyConstant {
	...
	public static final String LOGIN_PERSON_LOGGED_CHECKER_TRANSFORMER = "loginPersonLoggedCheckerTransformer";
	public static final String LOGIN_PERSON_COUNT_LOGINS_TRANSFORMER = "loginPersonCountLoginsTransformer";
}